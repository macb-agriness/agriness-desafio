...
Aplicação baseada no [Nest](https://github.com/nestjs/nest) para o desafio DEV NestJS da Agriness
...
```bash
# o comando abaixo instalará todas as dependências necessárias para a aplicação, incluindo o Redis
